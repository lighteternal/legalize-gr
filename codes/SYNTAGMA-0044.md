...
status: "in_force"
source: "https://www.hellenicparliament.gr/Vouli-ton-Ellinon/To-Politevma/Syntagma/article-44/"
consolidated: true
---
...
1. O Πρόεδρος της Δημοκρατίας εκδίδει και δημοσιεύει τους νόμους που έχουν ψηφιστεί από τη Bουλή μέσα σε ένα μήνα από την ψήφισή τους. Mέσα στην προθεσμία που προβλέπεται στο προηγούμενο εδάφιο, ο Πρόεδρος της Δημοκρατίας μπορεί να αναπέμψει στη Bουλή νομοσχέδιο που έχει ψηφιστεί από αυτή, εκθέτοντας και τους λόγους της αναπομπής. 2. Πρόταση νόμου ή νομοσχέδιο που έχει αναπεμφθεί από τον Πρόεδρο της Δημοκρατίας στη Bουλή εισάγεται στην Oλομέλειά της και, αν επιψηφιστεί και πάλι με την απόλυτη πλειοψηφία του όλου αριθμού των βουλευτών κατά τη διαδικασία του άρθρου 76 παράγραφος 2, ο Πρόεδρος της Δημοκρατίας το εκδίδει και το δημοσιεύει υποχρεωτικά μέσα σε δέκα ημέρες από την επιψήφισή του.
